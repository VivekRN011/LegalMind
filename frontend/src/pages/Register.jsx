...
import { Scale, Mail, Lock, User, AlertCircle, ArrowRight, Eye, EyeOff, CheckCircle } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 via-purple-600 to-indigo-800 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-4xl font-bold text-white mb-6">
            Start Analyzing<br />Contracts Today
          </h1>
        ...
        <div className="relative z-10">
          <p className="text-indigo-200 text-sm">
            Join 10,000+ legal professionals using LegalMind
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 mt-2">Get started with 5 free analyses</p>
            </div>
